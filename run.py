...
parser.add_argument('-checkpoint', type=str, default='checkpoints/hypo_selector/', help='Where to store the model checkpoint')
parser.add_argument('-logs', type=str, default='logs/hypo_selector/', help='Where to store the logs')
...
dataset_file = opt.dataset + ".json"
path = opt.dataset
dataset = OKVQA(path,dataset_file)
...
model_save_filepath = opt.checkpoint
logs_save_filepath = opt.logs
epoch_i = 1
